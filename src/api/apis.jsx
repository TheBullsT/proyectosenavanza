...
// API Diagnostico
export const apiDiagnostico = axios.create({
  baseURL: import.meta.env.VITE_API_URL_DIAGNOSTICO,
  withCredentials: true,
});
// API Crear Usuario
...
[apiGeneral, apiLogin, apiEmpresa, apiPerfil, apiCreateUser, apiDiagnostico].forEach(api => {
