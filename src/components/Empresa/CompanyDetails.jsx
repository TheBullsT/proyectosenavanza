...
const CompanyDetails = ({ data }) => (
    <div className="company-details">
      <div><strong>Tipo de Documento:</strong><br /><div className='answer-details'>{data.documentType}</div><hr /> </div>
      <div><strong>Número de Documento:</strong><br /><div className='answer-details'>  {data.documentNumber}</div><hr /> </div>
      <div><strong>Nombre de la empresa:</strong><br /><div className='answer-details'>  {data.name}</div><hr /> </div>
